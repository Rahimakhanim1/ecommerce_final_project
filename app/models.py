...
class Product(models.Model):
    ...
    size = models.ForeignKey(Size,null = True,on_delete = models.DO_NOTHING)
    color = models.ForeignKey(Color,null = True,on_delete = models.DO_NOTHING)
    tags = models.ForeignKey(Tags,null = True,on_delete = models.DO_NOTHING)
